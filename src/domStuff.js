...
function loadStartingPageHTML() {
  ...
  const wrapPage = content.appendChild(
    create.element("div", "class", "wrap-page")
  );
  const header = wrapPage.appendChild(create.element("header"));
  const banner = header.appendChild(create.element("div", "class", "banner"));
  const actionItems = banner.appendChild(
    create.element("div", "class", "action-items")
  );
  const addItemIcon = actionItems.appendChild(
    create.element("div", "class", "add-item-icon")
  );
  addItemIcon.appendChild(create.element("div", "class", "rect1"));
  addItemIcon.appendChild(create.element("div", "class", "rect2"));
  const notificationIcon = actionItems.appendChild(
    create.element("div", "class", "notification-icon")
  );
  notificationIcon.appendChild(
    create.element("div", "class", "notification-circle")
  );
  ...
  const belowHeaderWrapper = wrapPage.appendChild(
    create.element("div", "class", "below-header-wrapper")
  );
  const sideBar = belowHeaderWrapper.appendChild(
    create.element("div", "class", "side-bar")
  );
  const projectsHeaderWrapper = sideBar.appendChild(
    create.element("div", "class", "projects-header-wrapper")
  );
  const projectsHeader = projectsHeaderWrapper.appendChild(
    create.element("h1", "class", "projects-header")
  );
  ...
  const mainContentWrapper = main.appendChild(
    create.element("div", "class", "main-content-wrapper")
  );
  mainContentWrapper.appendChild(
    create.element("h2", "class", "recently-added")
  );
}

function loadAddToDoPageHTML() {
  const content = document.getElementById("content");
  const addToDoPageWrapper = content.appendChild(
    create.element("div", "id", "add-to-do-page-wrapper")
  );
  const addToDoBox = addToDoPageWrapper.appendChild(
    create.element("div", "class", "add-to-do-box")
  );
  const cancelAddToDoItem = addToDoBox.appendChild(
    create.element(
      "div",
      "class",
      "cancel-add-to-do-item",
      "",
      "id",
      "cancel-add-to-do-item"
    )
  ...
  const addTaskInputBox = addToDoBox.appendChild(
    create.element(
      "input",
      "class",
      "add-task-input-box",
  ...
  const addDescription = addToDoBox.appendChild(
    create.element(
      "textarea",
      "class",
      "add-description",
  ...
  const addToDoItemButton = addToDoBox.appendChild(
    create.element(
      "button",
      "id",
  ...
  const scheduleInputBox = addToDoBox.appendChild(
    create.element(
      "input",
      "class",
      "schedule-input-box",
  ...
  const priorityText = addToDoBox.appendChild(
    create.element("p", "class", "priority-text")
  );
  priorityText.textContent = "Priority?";
  const priorityWrapper = addToDoBox.appendChild(
    create.element("div", "class", "priority-wrapper")
  );
  const lowWrapper = priorityWrapper.appendChild(
    create.element("div", "class", "low-wrapper")
  );
  const priority1 = lowWrapper.appendChild(
    create.element("p", "class", "priority", "", "id", "low")
  );
  priority1.textContent = "Low";
  const highWrapper = priorityWrapper.appendChild(
    create.element("div", "class", "high-wrapper")
  );
  const priority2 = highWrapper.appendChild(
    create.element("p", "class", "priority", "", "id", "high")
  );
  priority2.textContent = "High";
  addToDoBox.appendChild(
    create.element(
      "div",
      "class",
      "project-tag-box",
  ...
  const projectTitleInputBox = addToDoBox.appendChild(
    create.element(
      "input",
      "class",
      "project-title-input-box",
      "",
      "id",
      "project-title-input-box"
    )
...
function renderToDoItems() {
  ...
  if (
    toDoItemsWrapper.style.display === "" ||
...
function updateToDoItemButtonListeners(selectedToDoItemData) {
  const addToDoItemButton = document.getElementById("add-to-do-item-button");
  addToDoItemButton.addEventListener(
    "click",
    updateToDoItem.bind(selectedToDoItemData),
    true
  );
...
function renderProjects() {
  ...
  const oldProjectsWrapper = document.getElementsByClassName(
    "projects-wrapper"
  )[0];
  oldProjectsWrapper.remove();
  const sideBar = document.getElementsByClassName("side-bar")[0];
  const projectsWrapper = sideBar.appendChild(
    create.element("div", "class", "projects-wrapper")
  );
  ...
  projectArray.forEach((projectItem, currentIndex) => {
    ...
    const projectDiv = projectsWrapper.appendChild(
      create.element("div", "class", "project")
    );
    const projectIconWrapper = projectDiv.appendChild(
      create.element(
        "div",
        "class",
    ...
    projectIconWrapper.appendChild(
      create.element("div", "class", "project-icon", "", "id", currentIndex)
    );
    const projectTitleLink = projectDiv.appendChild(
      create.element("a", "class", "project-link", "#")
    );
    projectTitleLink.textContent = projectItem.title;
    const toDoItemsWrapper = projectDiv.appendChild(
      create.element(
        "div",
        "class",
        "to-do-items-wrapper",
    ...
    toDoLists.forEach((toDoItem) => {
      const toDoLinkWrapper = toDoItemsWrapper.appendChild(
        create.element("div", "class", "to-do-link-wrapper")
      );
      const toDoLink = toDoLinkWrapper.appendChild(
        create.element(
          "p",
          "class",
          "to-do-link",
      ...
      const deleteButton = toDoLinkWrapper.appendChild(
        create.element("div", "class", "delete-button")
      );
      deleteButton.addEventListener(
        "click",
        deleteToDoItem.bind(toDoItem),
        true
      );
      deleteButton.appendChild(
        create.element("div", "class", "check-line-one")
      );
      deleteButton.appendChild(
        create.element("div", "class", "check-line-two")
      );
    });

    projectIconWrapper.addEventListener(
      "click",
      renderToDoItems.bind({ toDoItemsWrapper, projectIconWrapper }),
      true
    );
  });
  renderDropDowns();
...
function renderDropDowns() {
  ...
  dropDownElements.forEach((elementItem, currentIndex) => {
    ...
    const doesItExist = dropDownProjectTitles.findIndex(
      (dropDownProjectTitle) => dropDownProjectTitle === projectTitleFromPage
    );
    if (doesItExist !== -1) {
...
function makeAddToDoPageInteractive() {
  ...
  function changeDisplayForProjectTitleInputBox() {
    const projectTagBoxColor = this.style.backgroundColor;
    const tagProjectNameInputBox = document.getElementById(
      "project-title-input-box"
    );
    if (projectTagBoxColor === "black" || projectTagBoxColor === "") {
  ...
  function addProjectTagBoxListeners() {
    const projectTagBox = document.getElementById("project-tag-box");
    projectTagBox.addEventListener(
      "click",
      doProjectStuff.bind(projectTagBox),
      true
    );
  }
...
function returnHome(someData) {
  renderProjects();
  const addToDoItemPageWrapper = document.getElementById(
    "add-to-do-page-wrapper"
  );
